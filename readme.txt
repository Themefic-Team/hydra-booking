...
Hydra Booking is a flexible appointment scheduling and calendar management solution for WordPress
...
* **[One-on-One Meetings](https://demo.hydrabooking.com/one-to-one-meeting-zoom/)**: Personalize appointments with individual clients.
* **[Group Meetings](https://demo.hydrabooking.com/one-to-group-meeting/)**: Host group sessions and collaborate effectively.
* **[Recurring Meetings](https://demo.hydrabooking.com/one-to-one-recurring-meeting/)**: Set up recurring sessions for both one-on-one and group meetings
...
* **Phone Calls**: Offer phone-based consultations for convenience.
* **Custom Locations**: Tailor location details based on specific needs.
...
Track and analyze your business performance directly from your dashboard:
...
* Add appointment calendar to forms for event selection.
* Collect important attendee data through form integrations.
...
* Offer multiple meeting durations for clients to choose from.
* Add date overrides to accommodate special occasions or changes.
* Customize appointment descriptions for better service understanding.
* Include buffer times between appointments for preparation or breaks.
...
= Are payment options customizable? =
You can configure bookings as free or paid and accept payments through WooCommerce, PayPal, and Stripe.

= Can I assign different hosts to manage different bookings? =
...
- Added: Multi-language support for email template shortcodes.
- Added: Translation support for alert popup messages.
- Added: Option to disable meeting URLs.
...
- New: Added calendar option in email.
- Improvement: Security patch improved.
- Improvement: Settings menu position and menu icon added.
- Fixed: System stability issue resolved and minor issues fixed.

= 1.1.38 – Feb 15, 2026 =

- Fixed: Corrected minor typo in text.

= 1.1.37 – Feb 15, 2026 =

- Fixed: Resolved the custom availability issue.
- Updated: readme.txt file with the latest information.

= 1.1.36 – Jan 12, 2026 =

- Fixed: Popup notice issue has been resolved.
- Fixed: Meeting creation issue has been resolved.
...
- Fixed: Security vulnerability resolved.
- Improved: Access control and stability updates.
- Compatibility: Fully compatible with WordPress (v6.9).

= 1.1.30 – Nov 23, 2025 =

- Fixed: Issue with booking after pending confirmation.
...
- Improved: Enhanced system stability for better overall performance.

= 1.1.24 – October 05, 2025 =
...
- Fixed: Shortcode preview issue resolved.

= 1.1.19 – July 26, 2025 =

- Fixed: Vulnerability issue update for enhanced security.

= 1.1.18 – July 13, 2025 =

- Fixed: Media file uploader issue has been resolved.
...
- Compatibility: Compatible with WooCommerce (v9.9.5).
- Compatibility: Compatible with Contact Form 7 (v6.1).

= 1.1.14 – June 15, 2025 =

- Fixed: Required validation issue with the textarea field on the booking form.

= 1.1.13 – June 03, 2025 =

- Fixed: Notification selection issue resolved.

= 1.1.12 – June 02, 2025 =

- Added: Updated information in readme.txt file.
- Updated: New screenshots added for updated settings.
...
- Updated: License information updated on the frontend dashboard.

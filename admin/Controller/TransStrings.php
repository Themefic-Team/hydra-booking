  ...
  class TransStrings {
     ...
     public static function getTransStrings(){
        return array(
            ...
            'Attendee to a Mailchimp list' =>  __('Attendee to a Mailchimp list', 'hydra-booking'),  
            'An attendee has been added to the Mailchimp list' =>  __('An attendee has been added to the Mailchimp list', 'hydra-booking'),  
            'Booking added to cart' =>  __('Booking added to cart', 'hydra-booking'),  
            'Booking added to WC cart' =>  __('Booking added to WC cart', 'hydra-booking'),  
            'WC order processed' =>  __('WC order processed', 'hydra-booking'),  
            'An attendee has been processed the order' =>  __('An attendee has been processed the order', 'hydra-booking'),  
            'Rebook cencel meeting' =>  __('Rebook cencel meeting', 'hydra-booking'),  
            'Booking is updated successfully' =>  __('Booking is updated successfully', 'hydra-booking'),  
            'Attendee added to zoom meeting' =>  __('Attendee added to zoom meeting', 'hydra-booking'),  
            'An attendee added to zoom Meeting' =>  __('An attendee added to zoom Meeting', 'hydra-booking'),  
            'Zoom meeting created' =>  __('Zoom meeting created', 'hydra-booking'),  
            'Zoom meeting created for this booking' =>  __('Zoom meeting created for this booking', 'hydra-booking'),  
            'Zoom meeting updated' =>  __('Zoom meeting updated', 'hydra-booking'),  
            'Zoom meeting updated for this booking' =>  __('Zoom meeting updated for this booking', 'hydra-booking'),  
            'Attendee added to google calendar' =>  __('Attendee added to google calendar', 'hydra-booking'),  
            'An attendee has been added to the google calendar' =>  __('An attendee has been added to the google calendar', 'hydra-booking'),  
            'Google calendar event created' =>  __('Google calendar event created', 'hydra-booking'),  
            'A google calendar event has been created' =>  __('A google calendar event has been created', 'hydra-booking'),  
            'Attendee removed from google calendar' =>  __('Attendee removed from google calendar', 'hydra-booking'),  
            'Attendee removed from google calendar' =>  __('Attendee removed from google calendar', 'hydra-booking'),  
            'Google calendar event deleted' =>  __('Google calendar event deleted', 'hydra-booking'),  
            'Google calendar event deleted' =>  __('Google calendar event deleted', 'hydra-booking'),  
            'Attendee removed from google calendar' =>  __('Attendee removed from google calendar', 'hydra-booking'),  
            'Attendee removed from google calendar' =>  __('Attendee removed from google calendar', 'hydra-booking'),  
            'Google calendar rescheduled' =>  __('Google calendar rescheduled', 'hydra-booking'),  
            'Google calendar rescheduled' =>  __('Google calendar rescheduled', 'hydra-booking'),  
            'Added to mailchimp list' =>  __('Added to mailchimp list', 'hydra-booking'),  
            'An attendee has been added to the mailchimp list' =>  __('An attendee has been added to the mailchimp list', 'hydra-booking'),  
            'Sent meessage to telegram bot' =>  __('Sent meessage to telegram bot', 'hydra-booking'),  
            'Booking confirmation message sent to telegram' =>  __('Booking confirmation message sent to telegram', 'hydra-booking'),  
            'Booking cancel message sent to telegram' =>  __('Booking cancel message sent to telegram', 'hydra-booking'),  
            'Booking Re-scheduled message sent to telegram' =>  __('Booking Re-scheduled message sent to telegram', 'hydra-booking'),  
            'Contact from 7 form submitted' =>  __('Contact from 7 form submitted', 'hydra-booking'),  
            'Contact form 7 data stored' =>  __('Contact form 7 data stored', 'hydra-booking'),  
            'Fluent form submitted' =>  __('Fluent form submitted', 'hydra-booking'),  
            'Fluent form data stored' =>  __('Fluent form data stored', 'hydra-booking'),  
            'Forminator form submitted' =>  __('Forminator form submitted', 'hydra-booking'),  
            'Forminator form data stored' =>  __('Forminator form data stored', 'hydra-booking'),  
            'Payment completed via paypal' =>  __('Payment completed via paypal', 'hydra-booking'),  
            'An attendee has completed payment for the booking via paypal' =>  __('An attendee has completed payment for the booking via paypal', 'hydra-booking'),  
            'Sent data to FluentCRM' =>  __('Sent data to FluentCRM', 'hydra-booking'),  
            'Booking data sent to FluentCRM' =>  __('Booking data sent to FluentCRM', 'hydra-booking'),  
            'Sent data to Pabbly' =>  __('Sent data to Pabbly', 'hydra-booking'),  
            'Sent data to Zapier' =>  __('Sent data to Zapier', 'hydra-booking'),  
            'Booking data sent to webhook' =>  __('Booking data sent to webhook', 'hydra-booking'),  
            'Sent message to slack' =>  __('Sent message to slack', 'hydra-booking'),  
            'Booking confirmation message sent to slack' =>  __('Booking confirmation message sent to slack', 'hydra-booking'),  
            'Booking cancel message sent to slack' =>  __('Booking cancel message sent to slack', 'hydra-booking'),  
            'Booking Re-scheduled message sent to slack' =>  __('Booking Re-scheduled message sent to slack', 'hydra-booking'),  
            'Sent message to Twilio' =>  __('Sent message to Twilio', 'hydra-booking'),  
            'Booking confirmation message sent to slack' =>  __('Booking confirmation message sent to slack', 'hydra-booking'),  
            'Booking cencel message sent to slack' =>  __('Booking cencel message sent to slack', 'hydra-booking'),  
            'Booking Re-scheduled message sent to slack' =>  __('Booking Re-scheduled message sent to slack', 'hydra-booking'),  
            'Sent data to webhook' =>  __('Sent data to webhook', 'hydra-booking'),  
            'Booking data sent to webhook' =>  __('Booking data sent to webhook', 'hydra-booking'),   

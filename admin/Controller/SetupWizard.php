...
class SetupWizard {
	...
	public function CreateDemoMeetings( $request ) {
		...
		$data              = array(
			...
			'questions'                => '[{"label":"name","type":"Text","placeholder":"Name","options":[],"required":1},{"label":"email","type":"Email","options":[],"placeholder":"Email","required":1},{"label":"comment","type":"textarea","placeholder":"comment","options":[],"required":0}]',
			'payment_status'           => 0,
			'payment_method'           => '',
			'max_book_per_slot'        => 1,

...
<template>
    ...
    <div class="tfhb-content-wrap tfhb-flexbox tfhb-gap-tb-24">
         ...
         <AvailabilityPopupSingle v-if="isModalOpened" max_width="800px !important" :timeZone="timeZone.value" :availabilityDataSingle="availabilityDataSingle.value" :isOpen="isModalOpened" @modal-close="closeModal" :is_host="false" @update-availability="fetchAvailabilitySettingsUpdate" />

        ...
        <div class="tfhb-hydra-wrap ">    
            <nav v-if="$front_end_dashboard == false"  class="tfhb-hydra-admin-tabs tfhb-hydra-settings">  
                <ul>
                    ...
                    <li><router-link to="/settings/icalendar" exact :class="{ 'active': $route.path.startsWith('/settings/icalendar') }"> <Icon name="Calendar" /> {{ $tfhb_trans('iCalendar') }}</router-link></li>  
                    ...
                    <!-- Addons Settings -->
                    <li><router-link to="/settings/addons-settings" exact :class="{ 'active': $route.path.startsWith('/settings/addons-settings') }"> <Icon name="Blocks" /> {{ $tfhb_trans('Addons Settings') }}</router-link></li> 

        ...
        <HbPopup  :isOpen="outlookCalPopup" @modal-close="outlookCalPopup = false" max_width="800px" name="first-modal">
            ...
            <template #content>  
                ...
                <div class="tfhb-submission-btn tfhb-mt-8 tfhb-mb-8">
                    <button class="tfhb-btn boxed-btn tfhb-flexbox tfhb-hover-effect"   @click.stop="emit('update-integrations', 'apple_calendar', apple_calendar)">{{ $tfhb_trans('Update Host Settings') }} </button>
                </div> 
            </template> 
        </HbPopup>
